...
(
    ...
    hls_url          VARCHAR(512)       NOT NULL DEFAULT '' COMMENT 'HLS 播放地址 转码链路暂未接入 暂空',
    cover_url        VARCHAR(512)       NOT NULL DEFAULT '' COMMENT '封面图地址',
    duration         INT                NOT NULL DEFAULT 0 COMMENT '视频时长（秒）',
    transcode_status TINYINT            NOT NULL DEFAULT 10 COMMENT '转码状态 10=未开始 20=处理中 30=成功 40=失败',
  ...
  COLLATE = utf8mb4_bin
    COMMENT ='视频内容表 转码链路暂未接入 读端回退 origin_url';
