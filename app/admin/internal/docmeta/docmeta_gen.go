...
var docMeta = map[string]map[string]string{
	"GET /v1/admin/admins":                 {"description": "分页查询管理员列表", "permission": "admin:user:list"},
	...
	"GET /v1/admin/users/detail":           {"description": "C端用户详情", "permission": "user:detail"},
	...
	"POST /v1/admin/contents/review":       {"description": "先审后发审核", "permission": "content:review"},
	...
	"POST /v1/admin/roles/create":          {"description": "建角色", "permission": "admin:role:create"},
	"POST /v1/admin/roles/delete":          {"description": "删角色 禁删 super", "permission": "admin:role:delete"},
	"POST /v1/admin/roles/permissions":     {"description": "覆盖式设角色权限点", "permission": "admin:role:set-permissions"},
	"POST /v1/admin/roles/update":          {"description": "改角色名与备注 不可改 code", "permission": "admin:role:update"},
