...
var docMeta = map[string]map[string]string{
	...
	"GET /v1/admin/contents":               {"description": "内容列表", "permission": "admin:content:list"},
	"GET /v1/admin/contents/detail":        {"description": "内容详情 含非公开与正文", "permission": "admin:content:detail"},
	"GET /v1/admin/login-logs":             {"description": "登录审计日志", "permission": "admin:login-log:list"},
	"GET /v1/admin/me":                     {"description": "获取当前管理员信息与权限点"},
	...
	"POST /v1/admin/roles/create":          {"description": "创建角色", "permission": "admin:role:create"},
	"POST /v1/admin/roles/delete":          {"description": "删除角色 禁止删除 super", "permission": "admin:role:delete"},
	"POST /v1/admin/roles/permissions":     {"description": "覆盖式设角色权限点", "permission": "admin:role:set-permissions"},
	"POST /v1/admin/roles/update":          {"description": "修改角色名与备注", "permission": "admin:role:update"},
	"POST /v1/admin/users/status":          {"description": "C端用户封禁/恢复", "permission": "admin:cuser:ban"},
}
