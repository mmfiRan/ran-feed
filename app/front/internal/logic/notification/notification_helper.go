...
// collectRefIDs 从原始行去重收集 actor_ids 与 content_ids
...
// assembleNotificationItems 富化组装 front 层 NotificationItem
func assembleNotificationItems(items []*notifypb.NotificationItem, userMap map[int64]*userpb.UserInfo, contentMap map[int64]*contentpb.ContentItem) []types.NotificationItem {
