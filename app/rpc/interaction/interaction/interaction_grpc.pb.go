...
const (
	LikeService_Like_FullMethodName               = "/ranfeed.interaction.LikeService/Like"
	LikeService_Unlike_FullMethodName             = "/ranfeed.interaction.LikeService/Unlike"
	LikeService_QueryLikeInfo_FullMethodName      = "/ranfeed.interaction.LikeService/QueryLikeInfo"
	LikeService_BatchQueryLikeInfo_FullMethodName = "/ranfeed.interaction.LikeService/BatchQueryLikeInfo"
	LikeService_BatchQueryIsLiked_FullMethodName  = "/ranfeed.interaction.LikeService/BatchQueryIsLiked"
)
...
func (c *likeServiceClient) Like(ctx context.Context, in *LikeReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *likeServiceClient) Unlike(ctx context.Context, in *UnlikeReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type LikeServiceServer interface {
	Like(context.Context, *LikeReq) (*emptypb.Empty, error)
	Unlike(context.Context, *UnlikeReq) (*emptypb.Empty, error)
...
func (UnimplementedLikeServiceServer) Like(context.Context, *LikeReq) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Like not implemented")
}
func (UnimplementedLikeServiceServer) Unlike(context.Context, *UnlikeReq) (*emptypb.Empty, error) {
...
var LikeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ranfeed.interaction.LikeService",
...
const (
	FavoriteService_Favorite_FullMethodName          = "/ranfeed.interaction.FavoriteService/Favorite"
	FavoriteService_RemoveFavorite_FullMethodName    = "/ranfeed.interaction.FavoriteService/RemoveFavorite"
	FavoriteService_QueryFavoriteInfo_FullMethodName = "/ranfeed.interaction.FavoriteService/QueryFavoriteInfo"
	FavoriteService_QueryFavoriteList_FullMethodName = "/ranfeed.interaction.FavoriteService/QueryFavoriteList"
)
...
func (c *favoriteServiceClient) Favorite(ctx context.Context, in *FavoriteReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (c *favoriteServiceClient) RemoveFavorite(ctx context.Context, in *RemoveFavoriteReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type FavoriteServiceServer interface {
	Favorite(context.Context, *FavoriteReq) (*emptypb.Empty, error)
	RemoveFavorite(context.Context, *RemoveFavoriteReq) (*emptypb.Empty, error)
...
func (UnimplementedFavoriteServiceServer) Favorite(context.Context, *FavoriteReq) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Favorite not implemented")
}
func (UnimplementedFavoriteServiceServer) RemoveFavorite(context.Context, *RemoveFavoriteReq) (*emptypb.Empty, error) {
...
var FavoriteService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ranfeed.interaction.FavoriteService",
...
const (
	CommentService_Comment_FullMethodName            = "/ranfeed.interaction.CommentService/Comment"
	CommentService_DeleteComment_FullMethodName      = "/ranfeed.interaction.CommentService/DeleteComment"
	CommentService_QueryCommentList_FullMethodName   = "/ranfeed.interaction.CommentService/QueryCommentList"
	CommentService_QueryReplyList_FullMethodName     = "/ranfeed.interaction.CommentService/QueryReplyList"
	CommentService_BatchGetComments_FullMethodName   = "/ranfeed.interaction.CommentService/BatchGetComments"
	CommentService_RefillCommentCache_FullMethodName = "/ranfeed.interaction.CommentService/RefillCommentCache"
)
...
func (c *commentServiceClient) DeleteComment(ctx context.Context, in *DeleteCommentReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedCommentServiceServer) DeleteComment(context.Context, *DeleteCommentReq) (*emptypb.Empty, error) {
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ranfeed.interaction.CommentService",
...
const (
	FollowService_FollowUser_FullMethodName       = "/ranfeed.interaction.FollowService/FollowUser"
	FollowService_UnfollowUser_FullMethodName     = "/ranfeed.interaction.FollowService/UnfollowUser"
	FollowService_ListFollowees_FullMethodName    = "/ranfeed.interaction.FollowService/ListFollowees"
	FollowService_ListFollowers_FullMethodName    = "/ranfeed.interaction.FollowService/ListFollowers"
	FollowService_GetFollowSummary_FullMethodName = "/ranfeed.interaction.FollowService/GetFollowSummary"
)
...
var FollowService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ranfeed.interaction.FollowService",
