...
type ranFeedVideo struct {
	...
	MediaID         field.Int64  // åª’ä½“èµ„æºIDï¼ˆåŽŸå§‹è§†é¢‘ï¼‰
	OriginURL       field.String // åŽŸå§‹è§†é¢‘åœ°å€
	HlsURL          field.String // HLS æ’­æ”¾åœ°å€
	CoverURL        field.String // å°é¢å›¾åœ°å€
	Duration        field.Int32  // è§†é¢‘æ—¶é•¿ï¼ˆç§’ï¼‰
	TranscodeStatus field.Int32  // è½¬ç çŠ¶æ€ 10=æœªå¼€å§‹ 20=å¤„ç†ä¸­ 30=æˆåŠŸ 40=å¤±è´¥
	FailReason      field.String // å¤±è´¥åŽŸå›
