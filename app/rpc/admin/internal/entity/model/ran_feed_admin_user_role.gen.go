...
const TableNameRanFeedAdminUserRole = "ran_feed_admin_user_role"
...
// TableName RanFeedAdminUserRole's table name
func (*RanFeedAdminUserRole) TableName() string {
	return TableNameRanFeedAdminUserRole
}
